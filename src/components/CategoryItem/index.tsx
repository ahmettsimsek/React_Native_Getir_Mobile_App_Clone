...
function index({item}: CategoryItemProps){
  ...
  return (
    <TouchableOpacity onPress={() => navigation.navigate("CategoryDetails")} style={{width: width*0.25, height: height*0.11,marginTop: 25, flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between'}}>
